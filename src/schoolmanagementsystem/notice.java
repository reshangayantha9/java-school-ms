...
public class notice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 600, 160, 40));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            String sql = "update notice set n_name='" + jTextField2.getText() + "',n_date='" + jDateChooser1.getDate() + "',n_desc='" + jTextArea1.getText() + "'where n_id='" + jTextField1.getText() + "'";
            MyConn.save(sql);
            progress();
            JOptionPane.showMessageDialog(null, "'" + jTextField2.getText().toString() + "' notice Updated");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            String sql = "delete from notice where n_id='" + jTextField1.getText() + "'";
            MyConn.save(sql);
            progress();
            JOptionPane.showMessageDialog(null, "'" + jTextField2.getText().toString() + "' Notice Deleted");
            jProgressBar1.setValue(0);
            data();
            clear();
        } catch (Exception e) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            String sql = "insert into notice(n_id,n_name,n_date,n_desc)values('" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + jDateChooser1.getDate() + "','" + jTextArea1.getText() + "')";
            MyConn.save(sql);
            progress();
            JOptionPane.showMessageDialog(null, "'"+jTextField2.getText().toString()+"' New Notice Added");
            jProgressBar1.setValue(0);
            data();
            clear();
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String sql = "select*from notice where n_id='"+jTextField7.getText()+"'";
            ResultSet rs = MyConn.search(sql);
            DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
            int a = df.getRowCount();
            for (int i = 0; i < a; i++) {
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        try {
            String sql = "select*from notice where n_name like'"+jTextField7.getText()+"%'";
            ResultSet rs = MyConn.search(sql);
            DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
            int a = df.getRowCount();
            for (int i = 0; i < a; i++) {
