...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Student Gender");
        ...
        jLabel9.setText("Parent TP No");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 490, 120, 40));
        ...
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 490, 190, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S_ID", "S_Name", "S_Age", "S_Gender", "Adderss", "Parents Name", "TP No"
            }
        ));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 600, 160, 40));
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 600, 160, 40));
    ...
    void data() {
        try {
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("s_age"));
                v.add(rs.getString("s_gender"));
                v.add(rs.getString("s_address"));
                v.add(rs.getString("s_parents"));
                v.add(rs.getString("parents_tp"));
                df.addRow(v);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            String sql = "update student set s_name='" + jTextField2.getText() + "',s_age='" + jTextField3.getText() + "',s_gender='" + g + "',s_address='" + jTextField4.getText() + "',s_parents='" + jTextField5.getText() + "',parents_tp='" + jTextField6.getText() + "'where s_id='" + jTextField1.getText() + "'";
            MyConn.save(sql);
            progress();
            JOptionPane.showMessageDialog(null, "'" + jTextField2.getText().toString() + "' Student Updated");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            String sql = "delete from student where s_id='" + jTextField1.getText() + "'";
            MyConn.save(sql);
            progress();
            JOptionPane.showMessageDialog(null, "'" + jTextField2.getText().toString() + "' Student Deleted");
            jProgressBar1.setValue(0);
            data();
            clear();
        } catch (Exception e) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String sql = "insert into student(s_id,s_name,s_age,s_gender,s_address,s_parents,parents_tp)values('" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + jTextField3.getText() + "','" + g + "','" + jTextField4.getText() + "','" + jTextField5.getText() + "','" + jTextField6.getText() + "')";
            MyConn.save(sql);
            progress();
            JOptionPane.showMessageDialog(null, "'"+jTextField2.getText().toString()+"' New Student Added");
            jProgressBar1.setValue(0);
            data();
            clear();
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String sql = "select*from student where s_id ='" + jTextField7.getText() + "'";
            ResultSet rs = MyConn.search(sql);
            DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
            int a = df.getRowCount();
            for (int i = 0; i < a; i++) {
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        try {
            String sql = "select*from student where s_name like'" + jTextField7.getText() + "%'";
            ResultSet rs = MyConn.search(sql);
            DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
            int a = df.getRowCount();
            for (int i = 0; i < a; i++) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField6.setText((String) jTable1.getValueAt(sr, 6));
